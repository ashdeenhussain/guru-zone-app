...
export default function CreateTournamentPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            router.push('/dashboard/battle-zone'); // Redirecting to Battle Zone

        } catch (error: unknown) {
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            toast.error((error as any).message || 'Failed to create tournament');
        } finally {
            setIsLoading(false);
        }
    };
    ...
    return (
        <MaintenanceWrapper 
            isActive={true} 
            title="Match Hosting - Coming Soon"
            description="The ability to host your own matches is being upgraded. We'll be back with a more powerful hosting engine soon!"
        >
