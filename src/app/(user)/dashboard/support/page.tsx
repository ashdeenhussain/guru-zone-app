        ...
        <div className="p-4 pt-16 lg:pt-4 max-w-4xl mx-auto min-h-screen">
            <AnimatePresence mode="wait">
                {view === "list" ? (
                    ...
                    >
                        {/* Minimal Header */}
                        <div className="pt-2 pb-3 px-4 border-b border-border/40 bg-background/50 backdrop-blur-md sticky top-0 z-30 mb-6 flex items-center justify-between -mx-4 lg:mx-0 lg:rounded-xl">
