...
export default async function DashboardPage() {
    ...
    return (
        <div className="space-y-6 pb-24 lg:pb-8 max-w-4xl mx-auto p-4 md:p-6 animate-in fade-in-50 duration-500">
            {/* Cool Header with Avatar */}
            <DashboardHeader userName={user.name || 'Gamer'} avatarId={user.avatarId || 1} />
