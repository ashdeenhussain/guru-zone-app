        ...
        return (
            <div className="text-center space-y-4">
                ...
                <div className="bg-red-500/10 border border-red-500/50 p-4 rounded-lg">
                    <p className="text-red-400 font-medium whitespace-pre-line">
                        Invalid or missing password reset link. Please request a new link from the Forgot Password page.
                    </p>
                </div>
                <Link
                    href="/forgot-password"
                    className="block mt-6 text-blue-400 hover:text-blue-300 font-medium"
                >
        ...
        try {
            const res = await fetch('/api/auth/reset-password', {
                ...
                body: JSON.stringify({
                    ...
                    password: password // Included to fulfill the example payload just in case backend is also updated later
                }),
            });
