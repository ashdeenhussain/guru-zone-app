...
export const metadata: Metadata = {
  title: "Free Fire Tournament Karachi — Local Community Arena | Guru Zone",
  description: "Join the elite competitive circle in Karachi. Play free fire tournament karachi matches on the top esports earning platform. Win coins and withdraw cash instantly via EasyPaisa and JazzCash.",
  keywords: "free fire tournament karachi, free fire tournament pakistan, online earning game pakistan, guru zone karachi, karachi esports league",
  alternates: {
    canonical: "https://www.guru-zone.com/karachi",
  },
};
      ...
      <div className="max-w-5xl mx-auto space-y-16">
        ...
        <div className="text-center space-y-6">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/10 border border-primary/20 text-primary text-xs font-bold uppercase tracking-wider">
            <MapPin className="w-4 h-4" /> Karachi Esports Hub
          </div>
          ...
          <p className="text-muted-foreground text-lg sm:text-xl max-w-2xl mx-auto font-light leading-relaxed">
            Karachi's premier hub for competitive Free Fire players. Play daily tournaments, compete in 1v1 arenas, and cash out instantly on Pakistan's top esports community.
          </p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-6 rounded-3xl border border-border bg-card/30 backdrop-blur-sm">
          <div className="text-center space-y-1">
            <h3 className="text-2xl sm:text-3xl font-black text-primary">5,000+</h3>
            <p className="text-[10px] sm:text-xs text-muted-foreground uppercase tracking-widest font-semibold">Karachi Players</p>
          </div>
          <div className="text-center space-y-1">
            <h3 className="text-2xl sm:text-3xl font-black text-primary">220K+</h3>
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div className="space-y-6">
            <h2 className="text-2xl sm:text-3xl font-black uppercase tracking-tight text-foreground">
              Karachi Esports Scene is Dominated by Giants
            </h2>
            <p className="text-muted-foreground leading-relaxed">
              Guru Zone connects players from Karachi's top areas, including Clifton, Gulshan-e-Iqbal, Defense, and Nazimabad. Whether you want to test your squads in a full custom map battle or show your gunpower in a <strong className="text-foreground font-semibold">free fire tournament karachi</strong>, Guru Zone provides an official platform with anti-cheat protection.
            </p>
          ...
          <div className="bg-card/40 border border-border/80 rounded-3xl p-6 sm:p-8 space-y-6 relative overflow-hidden backdrop-blur-md">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center p-4 bg-muted/30 border border-border/50 rounded-2xl">
                <div>
                  <h4 className="font-bold text-sm text-foreground">Karachi Clash Squad League</h4>
                  <p className="text-[10px] text-muted-foreground font-semibold uppercase tracking-wider flex items-center gap-1.5 mt-1">
                    <Calendar className="w-3 h-3" /> Live Daily at 10:00 PM
                  </p>
                </div>
              ...
              <div className="flex justify-between items-center p-4 bg-muted/30 border border-border/50 rounded-2xl">
                <div>
                  <h4 className="font-bold text-sm text-foreground">Clifton Showdown</h4>
                  <p className="text-[10px] text-muted-foreground font-semibold uppercase tracking-wider flex items-center gap-1.5 mt-1">
