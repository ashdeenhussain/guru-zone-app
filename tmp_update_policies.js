...
async function updatePolicies() {
    ...
    const LandingPageContent = mongoose.models.LandingPageContent || mongoose.model('LandingPageContent', LandingPageContentSchema, 'landingpagecontents');
